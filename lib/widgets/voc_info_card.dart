...
class VocInfoCard extends StatelessWidget {
  ...
  const VocInfoCard({
    ...
    required this.cardIcon, // 아이콘 이모지를 꼭 받도록 변경
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        contentPadding: const EdgeInsets.all(9), // 내용물 주변에 모든 방향으로 20만큼 여백을 줘요.
        leading: SizedBox(
          width: 70,
          height: 60,
          child: Center(
